    ...
    <script>
        function Save() {
            ...
            for (var i = 1; i <= 3; i++) {
                ...
                param += "&Content" + (i) + "=" + encodeURIComponent(editorContent);
            }
                    ...
                    <table class="ww100" border="0" cellspacing="0" cellpadding="2">
                        ...
                        <tr class="no_line">
                            ...
                            <td>
                                ...
                                內容1：<br />
                                <textarea id="Content1" name="Content1"><%=Model.Content1 %></textarea>
                            </td>
                        </tr>
                        <tr class="no_line">
                            <td valign="top">&nbsp;</td>
                        ...
                        <tr class="no_line">
                            <td class="top">&nbsp;</td>
                            <td>內容2：<br />
                                <textarea id="Content2" name="Content2"><%=Model.Content2 %></textarea>
                            </td>
                        </tr>
                        <tr class="no_line">
                            <td class="top">&nbsp;</td>
                        ...
                        <tr class="no_line">
                            <td class="top">&nbsp;</td>
                            <td>內容3：<br />
                                <textarea id="Content3" name="Content3"><%=Model.Content3 %></textarea>
                            </td>
                        </tr>
                        <tr class="no_line">
                            <td class="top">&nbsp;</td>
