...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function Save() {
            ...
            utility.service("Page9Service/SaveCostKeyword", param, "POST", function (data) {
                if (data.code > 0) {
        ...
        function GoBack() {
            var redirto = utility.getRedirUrl('Page9', 'CostKeyword') + '?' + (new Date()).getMilliseconds();
