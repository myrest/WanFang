    ...
    <div id="mainpage">
        ...
        <table class="ww100 magTop10" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td class=" txt_r">
                    <input type="button" class="submit3 <%=CanNotEdit %>" onclick="window.location = '/Page9/EditDownLoad/';"
                        value="新增資料">
        ...
        <table class="ww100" border="0" cellpadding="2" cellspacing="1">
            ...
            <tr class="line-d mous01 top va_m">
                ...
                <td class="txt_c">
                    <input name="bt_edit" type="button" class="submit <%= CanNotEdit%>" onclick="window.location='/Page9/EditDownLoad/<%=item.WebDownLoadID %>';"
                        value="編輯">
                    <input name="bt_edit" type="button" class="submit4 <%=VeriferClass %> <%=(item.IsActive == 1) ? " hide " : "" %>" onclick="window.location='/Page9/EditDownLoad/<%=item.WebDownLoadID %>?Verify=1';"
                        value="審核">
                </td>
            </tr>
            <%
