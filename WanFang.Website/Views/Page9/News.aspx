...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        function DeleteSelected() {
            ...
            utility.service("Page9Service/DeleteNews", param, "POST", function (data) {
                if (data.code > 0) {
    ...
    <div id="mainpage">
        ...
        <div class="bg-s">
            <p>
                關鍵字：
                <input name="Subject" type="text" value="請輸入檔案名稱搜尋" onclick="this.value = '';" size="30"
        ...
        <table class="ww100" border="0" cellpadding="2" cellspacing="1">
            ...
            <tr class="line-d top mous01 va_m">
                ...
                <td class="txt_c">
                    <input name="bt_edit" type="button" class="submit" onclick="window.location='/Page9/EditNews/<%=item.CostNewsId %>';"
                        value="編輯">
                </td>
            </tr>
            <%
