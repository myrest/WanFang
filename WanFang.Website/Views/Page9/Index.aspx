...
<p class="clear"></p>
        ...
        %>
                <tr class="mous01 top line-d txt_c va_m">
                    <td>
                        <input type="checkbox" name="id" value="<%=item.CostUnitId %>" /></td>
                    <td><%=item.SortNum%></td>
                    <td class="txt_c">
                    <%
                ...
                Response.Write(DeptName);
                    ...
                    <td><%=item.UnitName%></td>
                    <td><%=(item.IsActive > 0) ? "上架" : "下架"%></td>
                    <td><%=item.LastUpdate%></td>
                    <td>
                        <input name="bt_edit" type="button" class="submit" onclick="window.location='/Page9/EditCostUnit/<%=item.CostUnitId %>';" value="編輯"></td>
                </tr>
                <%
            }    
                %>
