...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        ...
        function Save() {
            ...
            utility.service("Page5Service/SaveDoc", param, "POST", function (data) {
                if (data.code > 0) {
        ...
        function GoBack() {
            var redirto = utility.getRedirUrl('Page5', 'Doc') + '?' + (new Date()).getMilliseconds();
    ...
    <div id="mainpage">
            <table cellspacing="1" cellpadding="2" class="ww100" border="0">
                ...
                <tr class="line-d">
                    ...
                    <td>
                        <input type="file" id="DocPic" size="30"/>
                        <%=UrlExtension.PreviewImage(Model.pic, "DocPic")%>
