                    ...
                    <table class="ww100" border="0" cellspacing="0" cellpadding="2">
                        ...
                        <tr class="no_line">
                            ...
                            <td>
                                ...
                                內容1：<br />
                                <textarea id="ContentBody1" name="ContentBody1"><%=Model.ContentBody1 %></textarea>
                            </td>
                        </tr>
                        <tr class="no_line">
                            <td valign="top">
                        ...
                        <tr class="no_line">
                            ...
                            <td>
                                內容2：<br />
                                <textarea id="ContentBody2" name="ContentBody2"><%=Model.ContentBody2 %></textarea>
                            </td>
                        </tr>
                        <tr class="no_line">
                            <td class="top">
                        ...
                        <tr class="no_line">
                            ...
                            <td>
                                內容3：<br />
                                <textarea id="ContentBody3" name="ContentBody3"><%=Model.ContentBody3 %></textarea>
                            </td>
                        </tr>
                        <tr class="no_line">
                            <td class="top">
...
<asp:Content ID="Content3" ContentPlaceHolderID="JSContent" runat="server">
    <script>
        ...
        $(function () {
            for (var i = 1; i <= 3; i++) {
                Contents[i] = CKEDITOR.editor.replace('ContentBody' + i, {});
            }
        });
    </script>
</asp:Content>
