...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%
        ...
        WanFang.Domain.Edu_Filter filter = ViewData["Filter"] as WanFang.Domain.Edu_Filter;
    ...
    <script>
        function DeleteSelected() {
            ...
            utility.showPopUp('您確定要刪除嗎？', 3, function () {
                utility.service("DeleteService/DeleteEdu", param, "POST", function (data) {
                    if (data.code > 0) {
    ...
    <div id="Div1">
        ...
        <div id="nav" class="txt_r">
            <img src="/CDN/Images/Manage/icon01.gif" hspace="5" border="0" align="absmiddle"><a
                href="login.aspx">後端管理系統</a>&nbsp&#187&nbsp衛教園區管理&nbsp&#187&nbsp健康促進衛教活動管理</div>
        <p class="clear">
        </p>
    </div>
    <div id="mainpage">
